...
public final class MySQLUtility {
    ...
    /**
     * Parse ResultSet to UserInfo 
     * @param result ResultSet which contains UserInfo fields
     * @return UserInfo object
     * @throws SQLException 
     */
    public static UserInfo getUserInfo(ResultSet result) throws SQLException {
        UserInfo userInfo = new UserInfo(result.getInt(MySQLUserInfo.USER_INFO_ID));
        userInfo.setLogin(result.getString(MySQLUserInfo.LOGIN));
        userInfo.setFirstName(result.getString(MySQLUserInfo.FIRST_NAME));
        userInfo.setSurname(result.getString(MySQLUserInfo.SURNAME));
        userInfo.setMidleName(result.getString(MySQLUserInfo.MIDLE_NAME));
        return userInfo;
    }
}
